...
void LCD_SendCMD(u8 cmd)
{
	...
	DIO_SetPortValue(LCD_DATA_PORT,cmd2);
...
void LCD_Print_Char(u8 u8char)
{
	...
	u8char2=((u8char<<4)&(0xF0));

	DIO_SetPortValue(LCD_DATA_PORT,u8char2);
...
void LCD_Print_String(char* pu8str)
{
...
void LCD_Print_String_UART(u8* pu8str)
{
...
void LCD_Print_String_UART_PASSWORD(u8* pu8str)
{
